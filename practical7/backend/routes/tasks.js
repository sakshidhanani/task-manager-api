...
// NOTE: this router is mounted behind authMiddleware in server.js
// (app.use('/tasks', authMiddleware, taskRoutes)), so req.user is
// guaranteed to be set on every route below.
...
// validateCreateTask runs first and rejects malformed bodies (e.g. missing
// title) with a 400 before this handler - and before Mongoose - ever sees them.
